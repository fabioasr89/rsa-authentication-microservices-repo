package com.fabio.rest.jwt.utils;
...
public class JwtTokenUtils {
	...
	private  PrivateKey getPrivateKey() throws NoSuchAlgorithmException, InvalidKeySpecException {
		...
		secret=secret_key.replaceAll("-----BEGIN PRIVATE KEY-----","");
		secret=secret.replaceAll("-----END PRIVATE KEY-----","");
	...
	public  String generaToken(String username) throws NoSuchAlgorithmException, InvalidKeySpecException {
		PrivateKey privateKey=getPrivateKey();
		Map<String,Object> claims=getClaims(username);
		Date expiration=generateExpirationDate(30000);
		return Jwts.builder().
				setClaims(claims).setExpiration(expiration).signWith(SignatureAlgorithm.RS256,privateKey).compact();
	}
